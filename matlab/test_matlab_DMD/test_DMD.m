...
%  array = circ_pattern(1920,1200, radius);
 ...
 %Lattice
  array(:,:,1)=lattice_pattern(1920,1200,50,10,[0 1]);
%  array(:,:,2)=lattice_pattern(1920,1200,100,50,[0 10]);
%   array=repmat(array,1,1,10);
...
%% AlpSeqTiming
illumtime_us = int32(600*pictime); %in us. minimum accepted is 10us Ignored in uninterrupted binary mode
...
% alp_returnvalue = calllib('alp4395','AlpProjControl',...
%     deviceid, alp_proj_step, int32(2009)); % ALP_EDGE_RISING (to change frame on rising edge)
